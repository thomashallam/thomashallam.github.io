...
![Here is a typical User Research note taking board](0muralnotes.png){.external fig-alt="How we capture research insights manually using a tool called mural" fig-align=center width=1200px}
...
![Experimental workflow to find new folders and convert transcripts into Dataverse rows](1FolderAndTranscriptstoDV.png){.external fig-alt="" fig-align=center width=100%}
...
![It just takes persistence](2FailureFlows.png){.external fig-alt="Screenshot of" fig-align=center width=60%}
...
![Remove PID Prompt workflow](2RemovePidPrompt.png){.external fig-alt="" fig-align=center width=100%}
...
![Detect and remove personal data](2PIDCheck.jpg){.external fig-alt="" fig-align=center width=100%}
...
![Dataverse table showing all the transcript summaries after processing](3TranscriptSummaries.png){.external fig-alt="Dataverse table showing all the transcript summaries after processing" fig-align=center width=100%}
...
![Evaluate and summarise](4TranscriptSummary.png){.external fig-alt="" fig-align=center width=100%}
...
![AI Builder Credits](4AIBuilderCredits.png){.external fig-alt="Screenshot of Azure AI Builder credits - what does this mean? costs?" fig-align=center width=100%}
...
![Research findings report compiled by AI](6AIReporting.png){.external fig-alt="Screenshot of completed report" fig-align=center width=100%}
