...
In user-centred design, speaking to your users through an ongoing conversation is key to success! Whether this is discovery interviews, service design, or testing content and solutions - it is almost always impossible to make the right decisions without user research.
...
The correct answer to these quotes above are:

The time when your really don't need User Research is after the solution has been launched unsuccessfully and the project has to be closed down!