...
**TL;DR** This post is about my reflections 6-months into the new UCD-Lead / Lead User Researcher role 
...
* It was a considerable change for me - after 12 years work on 'frontline research', to move into a more strategic role which is about capability development
...
Unfortunately the work on a 'Citizen Panel for Health' which would bring together the many citizen contact lists that have grown across teams. 

This has had to be paused due to re-prioritisation of the backlog; however UKHSA Insights team are doing some interesting work in that space so we are waiting to see how that goes over the next few months as well before starting on what would we be a very similar project.
