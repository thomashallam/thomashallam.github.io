...
author: "Tom Hallam"
date: "2025-05-10"
categories: [Monthnotes, Strategy, Analytics, Culture Change, Leadership, Stakeholders, User-Centred Design, Wellbeing]
image: "Transform.png"
---
...
To support improvement and horizontal change, it might mean that for a short while teams must free up staff time, which impacts delivery. Difficult decisions about priority need to be made, somewhere, but in the longer run it would enable all teams to build brilliant services.
...
Ensure teams meet our own standards! Focus on enabling UCD culture and end-to-end service design.
