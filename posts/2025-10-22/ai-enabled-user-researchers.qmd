...
One of the biggest challenges we have is that outside our immediate colleagues, teams and stakeholders, among the wider organisation User-Centred Design (UCD) Operations (Research Ops & Design Ops) is not that well understood. 

In brief, UCD Ops includes *all* the infrastructure that underpins quality, productivity for the whole User-Centred Design profession and, ultimately, enabling the successful delivery of Digital Data and Tech projects.

![UCD Ops Scope](UCDOpsScope.png){.external fig-alt="Pyramid of UCD ops scope. From setting UCD strategy down to service delivery. UCD Ops underpins all our digital transformation teams." fig-align=center width=1200px}
...
We work very closely with our community to understand their needs and resolve those. This may be through onboarding, training, coaching, procurement of software, hardware, or building in-house solutions. 
...
* **Scaling** - once a workflow is deployed (build once), it can be repeated endlessly
...
The bigger question is... are workforce planning teams aware of this? Are they looking into how job descriptions might need to evolve, and be extended to consider multi-disciplinary nature? There is an higher technical complexity for many roles in the age of ai-empowered employees.

We know that many colleagues are now doing much more than their core role. Maybe "T-shaped people" will be a thing of the past?
...
The next AI-gen empowers will be like a toolkit full of Swiss-army-knives. The challenge for leaders and managers will be agreeing who does what work, in an environment where everyone can do almost everything.
