...
This week also the user research repository project has entered Beta stage. The "Find User Research" tool is being tested with teams starting to upload documents and for the UCD Ops quality check content. There is another small task ahead to migrate the tool into NHS infrastructure... which as well has an amazing number of hoops needed to be jumped through. 
